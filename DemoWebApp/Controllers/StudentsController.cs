...
namespace DemoWebApp.Controllers
{
    public class StudentsController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Index(string searchSection)
        {
            ViewData["GetStudentsDetails"] = searchSection;

            var students = from m in _context.Students select m;

            if (!String.IsNullOrEmpty(searchSection))
            {
                students = students.Where(s => s.Section.Contains(searchSection));
            }
